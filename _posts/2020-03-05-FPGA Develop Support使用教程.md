...
该插件为个人开发一开始只是兴趣，仅为开源出一份力，但是随着后期开发的深入遇到了瓶颈以及越来越多自己无法解决的问题，同时自己还要面临再一次的研究生考试，后面半年内可能无法持续更进，由于插件内容功能太多，教程也无法持续补充，在此表示歉意，你可以自由使用。最后，若是你喜欢这个插件，喜欢数字开发，欢迎与我一起交流。
